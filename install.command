...
echo
echo "  Настройки (значок в меню-баре → «Настройки»):"
echo "  • Ключ ЛЛМ — тогда рядом с транскриптом появятся очищенная версия и саммари."
echo "  • Реквизиты общей базы — тогда после встречи спросит, отправить ли туда."
echo
